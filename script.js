// Class definitions
        ...
        function demoAttribute() {
            const mobil = new Mobil("Toyota Avanza", "Hitam", 2023);
            const output = document.getElementById('attributeOutput');

            output.innerHTML = `
                <div class="output-title">✅ Attribute dari Object Mobil:</div>
                <p><span class="highlight">Merek:</span> ${mobil.merek}</p>
                <p><span class="highlight">Warna:</span> ${mobil.warna}</p>
                <p><span class="highlight">Tahun:</span> ${mobil.tahun}</p>
                <p style="margin-top: 15px; color: #94a3b8;">
                    Attribute adalah data/ciri yang dimiliki oleh sebuah object.
                    Setiap object Mobil bisa memiliki nilai attribute yang berbeda.
                </p>
            `;
        }
